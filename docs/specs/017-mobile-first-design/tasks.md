...
docker compose exec hatscoatsandboots pnpm list tailwindcss  # Verify 4.1.13
docker compose exec hatscoatsandboots pnpm list sharp  # Verify 0.34.4
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/types/mobile-first.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/config/breakpoints.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/config/test-viewports.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/config/touch-targets.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-navigation.spec.ts`
...
docker compose exec hatscoatsandboots pnpm exec playwright test e2e/tests/mobile-navigation.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-touch-targets.spec.ts`
...
docker compose exec hatscoatsandboots pnpm exec playwright test e2e/tests/mobile-touch-targets.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-horizontal-scroll.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-typography.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-orientation.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/blog-mobile-ux.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-card-layout.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-buttons.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-form-inputs.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-images.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/e2e/tests/mobile-footer.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/tailwind.config.ts`
...
docker compose logs hatscoatsandboots | grep -i error  # Should be none
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/styles/globals.css`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/styles/mobile-first-utilities.css`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/playwright.config.ts`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/scripts/validate-breakpoints.js`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/hooks/useDeviceType.ts`
...
```bash
docker compose exec hatscoatsandboots pnpm test src/hooks/useDeviceType.test.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/components/GlobalNav.tsx`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/src/app/page.tsx`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/scripts/optimize-images.js`
...
```bash
docker compose exec hatscoatsandboots node scripts/optimize-images.js
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/CLAUDE.md`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/docs/MOBILE-FIRST-GUIDE.md`
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/plop-templates/Component.tsx.hbs`
...
```bash
docker compose exec hatscoatsandboots npx lighthouse http://localhost:3000 --preset=mobile --output=html --output-path=./lighthouse-mobile.html
```
...
**File**: `/home/turtle_wolfe/repos/HatsCoatsAndBoots/docs/prp-docs/PRP-STATUS.md`
