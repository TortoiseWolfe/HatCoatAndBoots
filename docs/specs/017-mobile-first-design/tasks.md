...
docker compose exec hatcoatandboots pnpm list tailwindcss  # Verify 4.1.13
docker compose exec hatcoatandboots pnpm list sharp  # Verify 0.34.4
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/types/mobile-first.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/config/breakpoints.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/config/test-viewports.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/config/touch-targets.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-navigation.spec.ts`
...
docker compose exec hatcoatandboots pnpm exec playwright test e2e/tests/mobile-navigation.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-touch-targets.spec.ts`
...
docker compose exec hatcoatandboots pnpm exec playwright test e2e/tests/mobile-touch-targets.spec.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-horizontal-scroll.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-typography.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-orientation.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/blog-mobile-ux.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-card-layout.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-buttons.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-form-inputs.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-images.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/e2e/tests/mobile-footer.spec.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/tailwind.config.ts`
...
docker compose logs hatcoatandboots | grep -i error  # Should be none
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/styles/globals.css`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/styles/mobile-first-utilities.css`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/playwright.config.ts`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/scripts/validate-breakpoints.js`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/hooks/useDeviceType.ts`
...
```bash
docker compose exec hatcoatandboots pnpm test src/hooks/useDeviceType.test.ts
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/components/GlobalNav.tsx`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/src/app/page.tsx`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/scripts/optimize-images.js`
...
```bash
docker compose exec hatcoatandboots node scripts/optimize-images.js
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/CLAUDE.md`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/docs/MOBILE-FIRST-GUIDE.md`
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/plop-templates/Component.tsx.hbs`
...
```bash
docker compose exec hatcoatandboots npx lighthouse http://localhost:3000 --preset=mobile --output=html --output-path=./lighthouse-mobile.html
```
...
**File**: `/home/turtle_wolfe/repos/HatCoatAndBoots/docs/prp-docs/PRP-STATUS.md`
