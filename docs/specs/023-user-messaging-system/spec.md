...
- React 19.1.0 (already in HatsCoatsAndBoots)
...
- Vitest (unit tests) - already in HatsCoatsAndBoots
- Playwright (E2E tests) - already in HatsCoatsAndBoots
- Pa11y (accessibility) - already in HatsCoatsAndBoots
