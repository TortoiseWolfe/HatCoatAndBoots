...
- React 19.1.0 (already in HatCoatAndBoots)
...
- Vitest (unit tests) - already in HatCoatAndBoots
- Playwright (E2E tests) - already in HatCoatAndBoots
- Pa11y (accessibility) - already in HatCoatAndBoots
