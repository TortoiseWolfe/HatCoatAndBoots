...
**Input**: Feature specification from `/home/turtle_wolfe/repos/HatsCoatsAndBoots/specs/023-user-messaging-system/spec.md`
...
- Use component generator: `docker compose exec hatscoatsandboots pnpm run generate:component`
...
- Commands executed via: `docker compose exec hatscoatsandboots pnpm run <command>`
...
**Structure Decision**: Web application structure (Option 2) selected. HatsCoatsAndBoots uses Next.js App Router with:
...
All requirements align with HatsCoatsAndBoots constitution v1.0.1. No complexity exceptions needed.
