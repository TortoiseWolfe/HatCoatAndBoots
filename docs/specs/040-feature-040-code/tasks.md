...
```
Command: docker compose exec hatcoatandboots pnpm test
...
```
Command: docker compose exec hatcoatandboots pnpm test --coverage src/lib/logger/
...
```
Command: docker compose exec hatcoatandboots pnpm run build
