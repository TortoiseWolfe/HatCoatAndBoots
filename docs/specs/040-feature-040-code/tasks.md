...
```
Command: docker compose exec hatscoatsandboots pnpm test
...
```
Command: docker compose exec hatscoatsandboots pnpm test --coverage src/lib/logger/
...
```
Command: docker compose exec hatscoatsandboots pnpm run build
