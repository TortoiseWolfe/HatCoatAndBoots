...
docker compose exec hatscoatsandboots pnpm run generate:component SocialShareButton blog
docker compose exec hatscoatsandboots pnpm run generate:component SocialShareGroup blog
docker compose exec hatscoatsandboots pnpm run generate:component AuthorAvatar blog
docker compose exec hatscoatsandboots pnpm run generate:component AuthorBio blog
docker compose exec hatscoatsandboots pnpm run generate:component SocialLink blog
docker compose exec hatscoatsandboots pnpm run generate:component AuthorSocialLinks blog
docker compose exec hatscoatsandboots pnpm run generate:component AuthorProfile blog
docker compose exec hatscoatsandboots pnpm run generate:component ShareMetadata blog
```
...
docker compose exec hatscoatsandboots pnpm test SocialShareButton
...
docker compose exec hatscoatsandboots pnpm run analyze
