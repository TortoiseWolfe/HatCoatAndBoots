...
- [x] T022 [P] Run type-check: `docker compose exec hatscoatsandboots pnpm run type-check`
- [x] T023 [P] Run lint: `docker compose exec hatscoatsandboots pnpm run lint`
