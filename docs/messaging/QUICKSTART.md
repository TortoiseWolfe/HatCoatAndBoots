...
docker compose exec hatscoatsandboots pnpm exec supabase db diff
...
docker compose exec hatscoatsandboots pnpm test src/lib/messaging/__tests__/
...
docker compose exec hatscoatsandboots pnpm test tests/integration/messaging/
...
- **GitHub Issues**: https://github.com/TortoiseWolfe/HatsCoatsAndBoots/issues
- **Supabase Discord**: https://discord.supabase.com
- **HatsCoatsAndBoots Discussions**: https://github.com/TortoiseWolfe/HatsCoatsAndBoots/discussions
