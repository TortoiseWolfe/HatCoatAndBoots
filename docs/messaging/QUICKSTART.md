...
docker compose exec hatcoatandboots pnpm exec supabase db diff
...
docker compose exec hatcoatandboots pnpm test src/lib/messaging/__tests__/
...
docker compose exec hatcoatandboots pnpm test tests/integration/messaging/
...
- **GitHub Issues**: https://github.com/TortoiseWolfe/HatCoatAndBoots/issues
- **Supabase Discord**: https://discord.supabase.com
- **HatCoatAndBoots Discussions**: https://github.com/TortoiseWolfe/HatCoatAndBoots/discussions
