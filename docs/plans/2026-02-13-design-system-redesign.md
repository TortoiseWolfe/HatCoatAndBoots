# HatsCoatsAndBoots Design System Redesign
...
- "HatsCoatsAndBoots" evokes craftsmanship, power tools, building software
...
**HatsCoatsAndBoots-specific:** HatsCoatsAndBoots has 33 atomic directories (vs SpokeToWork's 29). Audit the extras for misplacement before moving.
...
Build HatsCoatsAndBoots brand theme with dark and light variants.
...
5. AnimatedLogo / SpinningLogo (HatsCoatsAndBoots's mallet)

HatsCoatsAndBoots-specific:

- Dice / DiceTray (gaming elements, unique to HatsCoatsAndBoots)
