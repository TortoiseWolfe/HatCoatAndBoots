# HatCoatAndBoots Design System Redesign
...
- "HatCoatAndBoots" evokes craftsmanship, power tools, building software
...
**HatCoatAndBoots-specific:** HatCoatAndBoots has 33 atomic directories (vs SpokeToWork's 29). Audit the extras for misplacement before moving.
...
Build HatCoatAndBoots brand theme with dark and light variants.
...
5. AnimatedLogo / SpinningLogo (HatCoatAndBoots's mallet)

HatCoatAndBoots-specific:

- Dice / DiceTray (gaming elements, unique to HatCoatAndBoots)
