...
if ! docker compose ps hatcoatandboots | grep -q "Up"; then
    echo "❌ Error: Docker container 'hatcoatandboots' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec hatcoatandboots pnpm exec playwright test tests/e2e/messaging/"
echo ""
