...
if ! docker compose ps hatscoatsandboots | grep -q "Up"; then
    echo "❌ Error: Docker container 'hatscoatsandboots' is not running"
...
echo ""
echo "Run E2E tests:"
echo "  docker compose exec hatscoatsandboots pnpm exec playwright test tests/e2e/messaging/"
echo ""
