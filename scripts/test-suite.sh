...
# Test Suite Runner for HatCoatAndBoots
...
echo ""
echo -e "${BLUE}${BOLD}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}${BOLD}║                  HatCoatAndBoots Comprehensive Test Suite               ║${NC}"
echo -e "${BLUE}${BOLD}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if in_docker; then
    ...
    CMD_PREFIX="docker compose exec hatcoatandboots"
fi
...
if ! in_docker; then
    ...
    docker compose restart hatcoatandboots > /dev/null 2>&1
