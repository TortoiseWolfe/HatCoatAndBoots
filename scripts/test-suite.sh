...
# Test Suite Runner for HatsCoatsAndBoots
...
echo ""
echo -e "${BLUE}${BOLD}╔══════════════════════════════════════════════════════════════════════╗${NC}"
echo -e "${BLUE}${BOLD}║                  HatsCoatsAndBoots Comprehensive Test Suite               ║${NC}"
echo -e "${BLUE}${BOLD}╚══════════════════════════════════════════════════════════════════════╝${NC}"
echo ""
...
if in_docker; then
    ...
    CMD_PREFIX="docker compose exec hatscoatsandboots"
fi
...
if ! in_docker; then
    ...
    docker compose restart hatscoatsandboots > /dev/null 2>&1
