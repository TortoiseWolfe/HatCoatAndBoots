...
- [ ] T026 [P] [US1] Create CreateGroupModal component using generator: `docker compose exec hatscoatsandboots pnpm run generate:component` - organisms/CreateGroupModal
