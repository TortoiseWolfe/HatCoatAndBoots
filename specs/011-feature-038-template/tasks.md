...
- [x] T008 [US1] Implement previous-rebrand detection (grep for "HatsCoatsAndBoots" count)
...
- [x] T012 [US1] Implement file renaming for files containing "HatsCoatsAndBoots" in name
...
**Independent Test**: Run `docker compose exec hatscoatsandboots git commit -m "test"` after change
