...
- [x] T008 [US1] Implement previous-rebrand detection (grep for "HatCoatAndBoots" count)
...
- [x] T012 [US1] Implement file renaming for files containing "HatCoatAndBoots" in name
...
**Independent Test**: Run `docker compose exec hatcoatandboots git commit -m "test"` after change
