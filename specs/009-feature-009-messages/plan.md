...
docker compose exec hatscoatsandboots pnpm run type-check  # No any type errors
docker compose exec hatscoatsandboots pnpm run lint        # No ESLint warnings
docker compose exec hatscoatsandboots pnpm test            # All tests pass

# Final verification
docker compose exec hatscoatsandboots pnpm run build       # Production build clean
```
...
| SC-006: A11y passes            | `docker compose exec hatscoatsandboots pnpm run test:a11y`                  |
