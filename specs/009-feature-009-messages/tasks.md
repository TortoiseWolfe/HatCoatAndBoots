...
- [x] T001 Run `docker compose exec hatscoatsandboots pnpm run type-check` and record current state
- [x] T002 [P] Run `docker compose exec hatscoatsandboots pnpm run lint` and record current warnings
...
- `docker compose exec hatscoatsandboots pnpm run test:a11y` passes
