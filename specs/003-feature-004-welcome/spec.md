...
A new user signs up and initializes their encryption keys. They automatically receive a welcome message from HatsCoatsAndBoots admin explaining E2E encryption.
...
- **Admin User**: UUID `00000000-0000-0000-0000-000000000001`, username `hatscoatsandboots`
...
2. Creates admin profile (username: `hatscoatsandboots`) if missing
