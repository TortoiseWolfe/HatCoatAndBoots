...
--- v1.0.1 Amendment (2026-06-03) — Drop the no-JS gate ---
  The Hat gate's "Every page has a no-JS fallback story (HTML works without
  JavaScript)" bullet was removed. It was acting as a hard design constraint on
  the interactive book viewer without earning its keep for this project's
  audience and delivery. Progressive enhancement remains available as a
  technique, but is no longer a CI-failing gate. Error boundaries, degraded
  external-dependency modes, and Lighthouse Best Practices ≥ 90 still stand
  under the Hat gate. MINOR amendment (a gate was relaxed, none added).
...
**Version**: 1.0.1 | **Ratified**: 2026-05-28 | **Last Amended**: 2026-06-03
