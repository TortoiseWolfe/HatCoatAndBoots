#!/usr/bin/env bash
# HatCoatAndBoots SpecKit harness config — sourced by every bash helper in this dir.
#
# Why this file exists: HatCoatAndBoots keeps specs under `features/<category>/<NNN-name>/`
...
# HatCoatAndBoots:      features/foundation/004-foo/spec.md
