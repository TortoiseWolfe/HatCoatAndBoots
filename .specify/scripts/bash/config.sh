#!/usr/bin/env bash
# HatsCoatsAndBoots SpecKit harness config — sourced by every bash helper in this dir.
#
# Why this file exists: HatsCoatsAndBoots keeps specs under `features/<category>/<NNN-name>/`
...
# HatsCoatsAndBoots:      features/foundation/004-foo/spec.md
