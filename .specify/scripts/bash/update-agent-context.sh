...
# github/spec-kit. HatCoatAndBoots's stance: CLAUDE.md is hand-curated, not auto-rewritten.
#
...
HatCoatAndBoots behavior: NO-OP. CLAUDE.md is hand-curated and not auto-rewritten.
...
EOF
        ...
        ;;
    claude)
        echo "[update-agent-context] No-op for HatCoatAndBoots: CLAUDE.md is hand-curated." >&2
        exit 0
        ;;
    *)
