...
# github/spec-kit. HatsCoatsAndBoots's stance: CLAUDE.md is hand-curated, not auto-rewritten.
#
...
HatsCoatsAndBoots behavior: NO-OP. CLAUDE.md is hand-curated and not auto-rewritten.
...
EOF
        ...
        ;;
    claude)
        echo "[update-agent-context] No-op for HatsCoatsAndBoots: CLAUDE.md is hand-curated." >&2
        exit 0
        ;;
    *)
