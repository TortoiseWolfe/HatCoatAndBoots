...
#
# HatsCoatsAndBoots adaptation: this is vendored from upstream github/spec-kit.
...
# Source HatsCoatsAndBoots-specific config (SPEC_KIT_FEATURES_ROOT, etc.)
...
get_current_branch() {
    ...
    # HatsCoatsAndBoots adaptation: recurse through features/<category>/* instead of flat specs/*.
...
#
# HatsCoatsAndBoots adaptation: searches recursively under features/<category>/<prefix>-*/
