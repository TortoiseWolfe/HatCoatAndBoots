...
#
# HatCoatAndBoots adaptation: this is vendored from upstream github/spec-kit.
...
# Source HatCoatAndBoots-specific config (SPEC_KIT_FEATURES_ROOT, etc.)
...
get_current_branch() {
    ...
    # HatCoatAndBoots adaptation: recurse through features/<category>/* instead of flat specs/*.
...
#
# HatCoatAndBoots adaptation: searches recursively under features/<category>/<prefix>-*/
