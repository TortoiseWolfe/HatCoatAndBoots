...
# HatCoatAndBoots adaptation: scans both flat specs_dir/* (upstream layout) and
# nested specs_dir/<category>/* (HatCoatAndBoots layout) so the next-feature-number
...
# HatCoatAndBoots adaptation: features live under features/<category>/, not specs/
