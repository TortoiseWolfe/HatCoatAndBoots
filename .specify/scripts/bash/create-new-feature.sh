...
# HatsCoatsAndBoots adaptation: scans both flat specs_dir/* (upstream layout) and
# nested specs_dir/<category>/* (HatsCoatsAndBoots layout) so the next-feature-number
...
# HatsCoatsAndBoots adaptation: features live under features/<category>/, not specs/
